...
export default function ManageDriversPage() {
  ...
  // Stat cards data
  const stats = [
    { label: "Total Earnings", value: "SAR 725", icon: <Banknote className="w-5 h-5 text-blue-500" />, bg: "bg-blue-50" },
    { label: "Today's Earnings", value: "SAR 125", icon: <Wallet className="w-5 h-5 text-orange-500" />, bg: "bg-orange-50" },
    { label: "Total Drivers", value: "56", icon: <Car className="w-5 h-5 text-blue-500" />, bg: "bg-blue-50" },
    { label: "Online Drivers", value: "12", icon: <Users className="w-5 h-5 text-red-500" />, bg: "bg-red-50" },
    { label: "On Active Trips", value: "15", icon: <Truck className="w-5 h-5 text-green-500" />, bg: "bg-green-50" },
  ];
    ...
    >
      <div className="flex flex-col gap-6 mt-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {stats.map((stat, idx) => (
            <div key={idx} className="bg-white rounded-xl p-5 border border-gray-100 flex flex-col gap-3 shadow-sm">
