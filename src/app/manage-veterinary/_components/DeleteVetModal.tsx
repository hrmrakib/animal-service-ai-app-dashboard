...
export function DeleteVetModal({ isOpen, onClose, onConfirm, vet }: DeleteVetModalProps) {
  if (!vet) return null;
    ...
    >
      <div className="flex flex-col gap-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Delete Veterinarian Account</h2>
        ...
        <div className="bg-red-50 border border-red-100 rounded-lg p-4">
          <p className="text-gray-800 font-medium mb-3">
            Are you sure you want to delete <span className="font-bold">{vet.name}</span>'s account?
          </p>
