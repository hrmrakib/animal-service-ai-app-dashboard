...
export default function VerifyCodePage() {
  ...
  return (
    ...
    >
      <form className="space-y-6 w-full flex flex-col mt-2" onSubmit={handleSubmit}>
        <div className="space-y-3">
          ...
          <div className="flex justify-end pt-2">
            <p className="text-[11px] text-gray-400">
              Didn't get the code?{" "}
              <button type="button" className="text-brand font-medium hover:text-brand-hover transition-colors">
                Resent Code
              </button>
            </p>
          </div>
