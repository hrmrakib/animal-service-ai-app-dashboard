      ...
      <div className='flex flex-col gap-6 mt-2'>
        ...
        <div className='flex flex-col lg:flex-row gap-6 lg:gap-0 items-stretch'>
          ...
          <div className='flex-1 bg-white rounded-xl border border-gray-100 p-6 shadow-sm'>
            <h3 className='text-[#d08726] font-bold text-lg mb-6'>
              For All Users
            </h3>
            <form onSubmit={handleSendAll} className='flex flex-col gap-5'>
              ...
              <div className='flex justify-center mt-2'>
                <Button
                  type='submit'
                  variant='primary'
                  className='bg-brand hover:bg-brand px-12 py-3 font-semibold'
                  disabled={allSending}
                >
                  {allSending ? (
          ...
          <div className='flex-1 bg-white rounded-xl border border-gray-100 p-6 shadow-sm'>
            ...
            <form onSubmit={handleSendSpecific} className='flex flex-col gap-5'>
              ...
              <div className='relative'>
                ...
                >
                  <span
                    className={specificRole ? "text-gray-900" : "text-gray-400"}
                  >
              ...
              <div className='relative'>
                ...
                >
                  <span
                    className={specificUser ? "text-gray-900" : "text-gray-400"}
                  >
